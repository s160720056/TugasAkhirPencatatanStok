<?php
    ...
    class ExportLaporan implements FromCollection, WithMapping, WithHeadingRow, WithHeadings, WithStyles, WithEvents
    {
        ...
        public function collection()
        {
            return NotaDetail::join('barang', 'barang.id_barang', '=', 'nota_detail.id_barang')
                ...
                ->select(
                    ...
                    'barang.harga_beli',
                    'nota.ppn',
                    DB::raw('((nota_detail.harga * (nota.ppn / 100))+nota_detail.harga) AS total_harga_ppn'),
                    'user.username'
                )
        ...
        public function registerEvents(): array
        {
            return [
                AfterSheet::class => function (AfterSheet $event) {
                    ...
                    $event->sheet->setCellValue('A3', 'Periode: ' . date('F', mktime(0, 0, 0, $this->bln, 10)) . ' / ' . $this->thn);
