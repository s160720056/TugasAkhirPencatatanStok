<?php
    ...
    class ExportLaporanTiga implements FromCollection, WithMapping, WithHeadingRow, WithHeadings, WithStyles, WithEvents
    {
        protected $barang,$toko,$tgl;

        public function __construct($barang,$toko,$tgl)
        {
          $this->barang=$barang;
          $this->toko=$toko;
          $this->tgl=$tgl;
        ...
        foreach ($this->barang as $id_barang) {
            $laporanBarang = NotaDetail::join('barang', 'barang.id_barang', '=', 'nota_detail.id_barang')
            ...
            $laporan = $laporan->merge($laporanBarang);
        } 
